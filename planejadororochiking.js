...
(function () {
  ...
  ============================================================ */
  window.__ORK_VERSAO__ = 34;
  console.log('%c[OROCHIKING] Painel v34 carregado', 'background:#e8ac0a;color:#1a1400;font-weight:bold;padding:2px 6px;border-radius:3px');
  ...
  painel.innerHTML =
    ...
    '<div id="ork-footer">' +
      ...
      'v34 · Escolha a aba e clique em Ativar — o script já abre no lugar certo.' +
    '</div>';
