  ...
  painel.innerHTML =
    ...
    '<div id="ork-body">' +
      ...
      '<div id="ork-freio-box">' +
        ...
        '</div>' +
        '<div id="ork-freio-dica">Modo de baixo risco, pra deixar rodando enquanto você dorme. ' +
        'Farm Hard travado em 0.5x, cunhagem a cada 5 min no mínimo, levas de ataque mais espaçadas ' +
        'e coletor com pausa maior. Menos requisição = menos chance de captcha e de cair a sessão.</div>' +
      '</div>' +
    '</div>' +
    '<div id="ork-footer">' +
